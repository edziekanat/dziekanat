...
import pl.edu.agh.edeansoffice.persistance.FieldOfStudyDao;
...
public class FieldOfStudyController {
	...
	@Autowired
	private FieldOfStudyDao fieldsOfStudyDao;
	...
	public String createFieldOfStudy(@RequestParam(value="name") String name, @RequestParam(value="department") String department,
		...
		FieldOfStudy fieldsOfStudy = new FieldOfStudy(name, department, level, profil, formOfStudy, speciality, numberOfSemesters, ects, totalNumberOfHours);
	...
	public String displayFieldsOfStudyList(Model model) {
		...
		List<FieldOfStudy> fieldsOfStudy = fieldsOfStudyDao.findAll();
